...
use Kraftdo\Shared\Privacidad\EstadoDePropagacion;
use Kraftdo\Shared\Privacidad\PropagacionInvalida;
use Kraftdo\Shared\Privacidad\ResultadoDePropagacion;

/**
 * El tercer estado de la propagación al registro maestro.
 *
...
it('no correspondía propagar: no es éxito, y no se puede confundir con él', function () {
    $resultado = ResultadoDePropagacion::noCorrespondia('Este ambiente no tiene registro maestro configurado.');
    ...
    expect($resultado->estado)->toBe(EstadoDePropagacion::NoCorrespondia)
        ...
        ->and($resultado->motivo)->toBe('Este ambiente no tiene registro maestro configurado.');
});
