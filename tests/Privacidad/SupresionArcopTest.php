...
use Kraftdo\Shared\Privacidad\Bloqueos;
...
use Kraftdo\Shared\Privacidad\Modelos\Bloqueo;
...
use Kraftdo\Shared\Privacidad\SupresionEnCurso;
use Kraftdo\Shared\Privacidad\Supresiones;
use Kraftdo\Shared\Privacidad\SupresionNoProcede;
...
it('se niega igual que la retención si el sistema no declaró qué pasa con el maestro', function () {
    ...
    expect(fn () => app(Supresiones::class)->aplicar($this->solicitud, 'Se acoge.'))
        ->toThrow(SupresionNoPropagada::class, 'registro maestro');
