...
use Kraftdo\Shared\Privacidad\Contratos\PropagaRectificacion;
...
use Kraftdo\Shared\Privacidad\RectificacionNoPropagada;
use Kraftdo\Shared\Privacidad\ResolucionInvalida;
...
it('un sistema con maestro que decide no hablarle deja escrito su motivo', function () {
    ...
    app()->bind(PropagaRectificacion::class, fn () => new class implements PropagaRectificacion
    {
        public function propagar(Model $titular, array $cambios): ResultadoDePropagacion
        {
            return ResultadoDePropagacion::noCorrespondia('El titular no está dado de alta en el registro maestro.');
        }
    });
    ...
    expect($this->titular->refresh()->nombre)->toBe('Rocío Paredes')
        ...
        ->toBe([
            ...
            'motivo' => 'El titular no está dado de alta en el registro maestro.',
        ]);
});
