...
use Kraftdo\Shared\Seguridad\SegundoFactorEnProduccion;
use Kraftdo\Shared\Testing\AssertSegundoFactorNoSeRegala;
 ...
 * panel describe un TOTP con `emisor` y sin `show_code`; otro sistema
