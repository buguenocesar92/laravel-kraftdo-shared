...
/**
 * Qué pasó cuando el sistema le llevó al registro maestro una rectificación
 * o una supresión.
 *
...
final readonly class ResultadoDePropagacion
{
     ...
     *
     * Es la única respuesta con la que la organización puede certificar por
    ...
    public static function noCorrespondia(string $motivo): self
    {
        if (trim($motivo) === '') {
            throw new PropagacionInvalida(
                ...
                .'no se habló con el registro maestro y no puede responder por qué, que es exactamente '
