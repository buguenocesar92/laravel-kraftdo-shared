 ...
 *
 * Es el punto de extensión que ningún panel puede resolver por su cuenta: un
 * sistema busca por RUT contra la columna generada `nro_documento_norm` de
 ...
 * distinto, el mismo titular recibe respuestas distintas según qué mesón lo
 * atendió.
 *
 ...
 * es la superficie por donde se puede ENUMERAR el padrón de una organización.
 */
