...
namespace Kraftdo\Shared\Privacidad\Console;
 ...
 * adoptarlo en el ecosistema, no una precaución imaginada:
 *
...
class DiagnosticoCommand extends Command
{
    ...
    private function revisarIdentidadDelSistema(): array
    {
        ...
        if ($finalidades === 0) {
            return [[
                ...
                'arreglo' => 'Sembrar las finalidades con su base de licitud, su norma y su plazo. Es una declaración jurídica: la escribe la organización, no el código.',
            ]];
        }
    ...
    private function revisarResponsable(): array
    {
        ...
        $consecuencia = match (true) {
            ...
            $faltaSoloDelegado => 'El expediente sale sin identificar al delegado de protección de datos. La ley pide saber a QUIÉN responde el tratamiento, y designarlo es un acto de la organización: no se resuelve poniendo el mismo correo de contacto, porque es una persona y no un buzón.',
        ...
        return [[
            ...
            'arreglo' => 'Definir esas variables en el .env. Qué correo y qué persona van ahí lo decide la organización.',
        ]];
    }
