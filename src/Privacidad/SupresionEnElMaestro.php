 ...
 * adoptante y qué pasa si el registro maestro no acepta.
 *
...
final class SupresionEnElMaestro
{
    ...
    public function exigirDeclaracion(): void
    {
        ...
        throw new SupresionNoPropagada(
            'El sistema no declaró qué debe pasar en el registro maestro al suprimir a un titular. '
    ...
    public function propagar(TitularDeDatos $titular, string $documento): ResultadoDePropagacion
    {
        ...
        if ($resultado->laRechazoElMaestro()) {
            throw new SupresionNoPropagada(
                'El registro maestro rechazó la supresión: no se destruye el dato local, '
